...
if btn_run:
    ...
    with st.spinner(t["fetching"]):
        ...
        # Note: df_aq est initialisé ici. Il faudra ajuster l'appel API ci-dessous selon les indicateurs et le pas de temps de Qualité de l'Air souhaités.
...
if st.session_state['has_run']:
    if st.session_state['df_1h'] is None and st.session_state['df_15m'] is None and st.session_state['df_aq'] is None and st.session_state['df_alerts'] is None:
        ...
        t1, t2, t3, t4 = st.tabs([t["tab_1h"], t["tab_15m"], t["tab_aq"], t["tab_alerts"]])
